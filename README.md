...
## 🖥️ Next tasks:
*  Create obstacles you can only move through by dashing
*  Finish entity interactions & sprite them properly
*  Build UI showing playerHealth & amount of dash charges
...
* :heavy_exclamation_mark: UI that shows: the amount of health the player has left: moved up in priority
